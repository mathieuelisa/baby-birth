      ...
      <div className='space-y-8'>
        ...
        <div className='grid gap-4 sm:grid-cols-2'>
          ...
          <button
            ...
            className='group cursor-pointer flex flex-col items-center gap-4 rounded-xs bg-[#ffffff] p-8 text-center shadow-sm transition-all hover:border-[#9a7c66] hover:shadow-md'
          >
