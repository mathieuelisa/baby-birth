...
import { usePronosticQuestions, useUpsertAnswers, useUserAnswers } from "@/hooks/use-pronostics";
...
export default function PronosticsPage() {
  ...
  const { data: existingAnswers, isLoading: loadingA } = useUserAnswers(user!.id);
